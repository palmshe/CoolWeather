...
import com.palmshe.newcoolweather.utils.constant.Constant;
...
public class DES {
	...
	public String authcode(String content, String operation, String key){
		...
		if (operation != null && operation.equals(Constant.ENCODE)) {
			encontent = encrypt(content,key);
		} else if (operation != null && operation.equals(Constant.DECODE)) {
	...
	public static void main(String[] args) {
		DES des = new DES();
		System.out.println(des.authcode("wewweewewew=",Constant.ENCODE,"0102030405060708"));//加密
		System.out.println(des.authcode("d8fPhfd9JkW99p8aqhtVIA==",Constant.DECODE,"0102030405060708"));//解密
	}
}